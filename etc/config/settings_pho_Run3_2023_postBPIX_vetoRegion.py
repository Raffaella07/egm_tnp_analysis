...
#############################################################
tnpParNomFit = [
    "meanP[0.0,-3.0,3.0]","sigmaP[0.8,0.5,1.0]",
    "meanF[-0.0,-5.0,5.0]","sigmaF[1.5,0.3,3.0]",
    "acmsP[60.,50.,80.]","betaP[0.03,0.01,0.08]","gammaP[0.5, -2, 1]","peakP[90.0]",
    "acmsF[60.,50.,80.]","betaF[0.05,0.01,0.08]","gammaF[0.5, -2, 1]","peakF[90.0]",
    ]

tnpParAltSigFit = [
    "meanP[-0.0,-5.0,5.0]","sigmaP[1,0.7,4.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,1.3,6.0]","sosP[1,0.5,5.0]",
    "meanF[-0.0,-5.0,5.0]","sigmaF[2,0.7,4.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.5,1.5,6.0]","sosF[1.4,1,5.0]",
...
tnpParAltBkgFit = [
    ...
    "meanF[0.5,-5.0,5.0]","sigmaF[3.0,1.5,6.0]",
    "alphaP[0.,-5.,5.]",
    "alphaF[0.,-5.,5.]",
    ]
tnpParAltBkgFit_pol = [
    ...
    "a1_P[0.,-1.,1.]","a2_P[0.,-1.,1.]","a3_P[0.,-5.,5.]","a4_P[0.,-5.,5.]",
    "a1_F[-0.1.,-0.5.,0.]","a2_F[-0.2.,-1.,0]","a3_F[0.,-5.,5.]","a4_F[0.,-5.,5.]",
    ]
