...
#if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_weight(weightName)
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_weight(weightName)
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('/eos/cms/store/group/phys_egamma/ec/fmausolf/EGM_comm/124X_preLeak_DYTo2E_M-50_NNPDF31_TuneCP5_13p6TeV-powheg-pythia8_EleID_PhoID/DYto2E_M-50_NNPDF31_TuneCP5_13p6TeV-powheg-pythia8/124X_preLeak_DYTo2E_M-50_NNPDF31_TuneCP5_13p6TeV-powheg-pythia8_EleID_PhoID/230124_110236/0000/DY_powheg_pho.pu.puTree_1.root')
...
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('/eos/cms/store/group/phys_egamma/ec/fmausolf/EGM_comm/124X_preLeak_DYTo2E_M-50_NNPDF31_TuneCP5_13p6TeV-powheg-pythia8_EleID_PhoID/DYto2E_M-50_NNPDF31_TuneCP5_13p6TeV-powheg-pythia8/124X_preLeak_DYTo2E_M-50_NNPDF31_TuneCP5_13p6TeV-powheg-pythia8_EleID_PhoID/230124_110236/0000/DY_powheg_pho.pu.puTree_1.root')
...
tnpParNomFit = [
    ...
    "meanF[-0.0,-5.0,5.0]","sigmaF[1.9,0.5,5.0]",
