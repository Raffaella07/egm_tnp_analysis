...
baseOutDir = 'results/Run3_2023_preBPIX/tnpPhoID/'
...
samplesDef = {
    'data'   : tnpSamples.Run3_2023_preBPIX['data_2023'].clone(),
    'mcNom'  : tnpSamples.Run3_2023_preBPIX['DY_madgraph'].clone(),
    'mcAlt'  : tnpSamples.Run3_2023_preBPIX['DY_amcatnlo'].clone(),
    'tagSel' : tnpSamples.Run3_2023_preBPIX['DY_madgraph'].clone(),
}
...
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_weight(weightName)
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_weight(weightName)
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('/eos/cms/store/group/phys_egamma/ec/tnpTuples/Prompt2023/pileupReweightingFiles/preBPIX/DY_amcatnloext_pho.pu.puTree.root')
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_puTree('/eos/cms/store/group/phys_egamma/ec/tnpTuples/Prompt2023/pileupReweightingFiles/preBPIX/DY_madgraph_pho.pu.puTree.root')
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('/eos/cms/store/group/phys_egamma/ec/tnpTuples/Prompt2023/pileupReweightingFiles/preBPIX/DY_amcatnloext_pho.pu.puTree.root')
...
#############################################################
### cut
cutBase   = 'tag_Ele_pt > 33 && abs(tag_sc_eta) < 2.17'
...
additionalCuts = {
   ...
   3 : 'tag_Ele_pt > 80 && tag_Ele_Iso122X> 0.99',
   4 : 'tag_Ele_pt > 80 && tag_Ele_Iso122X> 0.99',
   5 : 'tag_Ele_pt > 80 && tag_Ele_Iso122X> 0.99',
   6 : 'tag_Ele_pt > 80 && tag_Ele_Iso122X> 0.99',
...
#############################################################
tnpParNomFit = [
    "meanP[90.0,70,95.0]","sigmaP[4,0.3,10.0]",
    "meanF[90.0,70.0,95.0]","sigmaF[2,0.3,10.0]",
    "acmsP[60.,50.,80.]","betaP[0.03,0.01,0.05]","gammaP[0.5, -2, 1]","peakP[90.0]",
    "acmsF[70.,60.,80.]","betaF[0.05,0.01,0.08]","gammaF[0.5, -2, 1]","peakF[90.0]",
    ]

tnpParAltSigFit = [
    "meanP[-0.0,-2.0,2.0]","sigmaP[1.3,0.5,5]","alphaP[2.0,1.2,4]",'nP[3,-5,5]',"sigmaP_2[3,1,10]","sosP[1.5,0.7,1.7]",
    "meanF[-0.0,-2.0,2.0]","sigmaF[1.3,0.5,5]","alphaF[2.0,1.2,4]",'nF[3,-5,5]',"sigmaF_2[3,1,10]","sosF[1.5,0.7,1.7]",
    "acmsP[60.,50.,80.]","betaP[0.02,0.01,0.05]","gammaP[0.04, 0.001, 1]","peakP[90.0]",
    "acmsF[60.,50.,80.]","betaF[0.02,0.01,0.05]","gammaF[0.04, 0.001, 1]","peakF[90.0]",
    ]
    
tnpParAltSigFit_addGaus = [
    "meanP[-0.0,-5.0,5.0]","sigmaP[1,0.7,6.0]","alphaP[2.0,1.2,3.5]" ,'nP[3,-5,5]',"sigmaP_2[1.5,0.5,4.0]","sosP[1,0.5,5.0]",
    "meanF[-0.0,-5.0,5.0]","sigmaF[2,0.7,6.0]","alphaF[2.0,1.2,3.5]",'nF[3,-5,5]',"sigmaF_2[2.0,0.5,4.0]","sosF[0.7,0.2.0]",
...
tnpParAltBkgFit_pol = [
    "meanP[-0.0,-5.0,5.0]","sigmaP[0.9,0.5,5.0]",
    "meanF[0.5,-5.0,5.0]","sigmaF[3.0,1.0,5.0]",
    "meanGF[80.0,70.0,100.0]","sigmaGF[10,1.0,30.0]",
    "a1_P[-0.1.,-1.,0.]","a2_P[0.,-1.,0.]","a3_P[0.,-1.,1.]","a4_P[0.,-1.,1.]",
    "a1_F[-0.1.,-1.,0.]","a2_F[-0.2.,-1.,0]","a3_F[0.,-1.,1.]","a4_F[0.,-1.,1.]",
    ]
